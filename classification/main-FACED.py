...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str, default=r"D:\seed")
    parser.add_argument('--subjects', type=int, default=123)
    parser.add_argument('--data-exist', action='store_true', default=False)
    ...
    parser.add_argument('--sub-segment', type=int, default=4)
    ...
    parser.add_argument('--graph2token', type=str, default='Linear',
    ...
    if not args.data_exist:
        ...
        pd.create_dataset(
            ...
            band_pass_first=False if args.data_format in ['PSD', 'rPSD'] else True
        )
